  ...
  return (
    <View style={styles.seatContainer}>
      <svg width="32" height="32" viewBox="0 0 24 24">
        ...
        {status === "occupied" && (
          <path d="M6 8L18 16M18 8L6 16" stroke="#999" strokeWidth="2" />
        )}
        {status === "selected" && (
          <path
            d="M8 12L11 15L16 10"
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={styles.progressStep}>
          ...
          <Text style={styles.inactiveStepText}>Chọn đ</Text>
        </View>
      </View>
      ...
      <View style={styles.tripInfo}>
        <Text style={styles.tripInfoText}>
          ℹ️ Đây là chặng thuộc chuyến 12:00 • 02/09/2025 Sài Gòn - Tân Châu
          (Châu Đốc)
        </Text>
      </View>
